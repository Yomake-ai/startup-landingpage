# Azzle Home 1 - Vite Landing Page

This is a standalone Vite + React + TypeScript landing page converted from the Next.js Azzle template (Home 1 design).
